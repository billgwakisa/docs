...
## Prefer to let your agent build it?

Point Claude Code or Cursor at the x-bridge MCP and it writes x-bridge into your app — token client, your use-case flow, and the rules, baked in.

<Card title="Build with your AI agent" icon="robot" href="/mcp" horizontal>
  Scaffold x-bridge into your codebase from your editor. Integrate mode writes code — it never calls live APIs on its own.
</Card>
