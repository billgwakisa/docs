...
## Two things to know before you send money

<Columns cols={2}>
  <Card title="Money units differ" icon="triangle-exclamation" href="/concepts/conventions">
    Wallet amounts are minor units (cents). Loan `principal` is in major units. Read the field.
  </Card>
  <Card title="Tokens expire hourly" icon="key" href="/authentication">
    On a 401, re-generate the token and retry once. Built into the recipes.
  </Card>
</Columns>
