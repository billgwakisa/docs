...
## Or build it with your AI agent

Point Claude Code or Cursor at the x-bridge MCP server and build by describing what you want — every tool is generated from this API.

```bash
claude mcp add x-bridge -- npx -y @x-bridge/mcp
```

Then just ask: *"Onboard a customer named Jane and disburse a 100,000 TZS loan into her wallet."* Read tools work out of the box; money-moving tools stay locked until you enable them at launch.

<Card title="Set up the MCP server" icon="robot" href="/mcp" horizontal>
  Install for Claude Code or Cursor, and see the launch-time safety model.
</Card>
