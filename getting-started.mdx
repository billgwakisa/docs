...
# 2. Pick a published loan product (principal is in MAJOR units)
...
<Warning>
**`principal` is in major units** (`100000` = 100,000 TZS). Wallet amounts elsewhere use minor units. This mismatch is the most common money bug — see [Conventions](/concepts/conventions).
</Warning>
